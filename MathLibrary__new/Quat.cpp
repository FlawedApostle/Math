...
float Quaternion::dotQuaternion(float dotv , float maga, float magb)
{	
	/*
	dotValue = |a| * |b| * cos(theta)
	dotV = |maga| * |magb| * cos(theta)
	cos(theta) = |maga| * |magb| / dotV
	*/
	float dotValue = maga * magb / dotv;
